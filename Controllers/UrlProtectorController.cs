...
namespace Rijkshuisstijl.UrlProtector.Controllers
{
    ...
    public class UrlProtectorController : Controller
    {
        ...
        public ActionResult Show()
        {
            ...
            UrlFilter filter = new UrlFilter(_workContextAccessor, _filteredRequestRecords, _cachedUrlProtectorRules, _orchardServices);

            ShowViewModel viewModel = new ShowViewModel(_cachedUrlProtectorRules.DashboardFilterRecords, _cachedUrlProtectorRules.UrlFilterRecords, _filteredRequestRecords.Table, filter.UserHostAddress, filter.UserAgent);
